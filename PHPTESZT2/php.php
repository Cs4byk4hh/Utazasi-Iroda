...
// Megjelenítés
echo "<table border='1'>";
echo "<tr><th>Ország 1</th><th>Repülőtér 1</th><th>Kiválasztás</th><th>Ország 2</th><th>Repülőtér 2</th><th>Kiválasztás</th></tr>";
...
while ($row1 || $row2) {
    ...
    if ($row1) {
        echo "<td>" . $row1['orszag1'] . "</td>";
        echo "<td>" . $row1['repter1'] . "</td>";
        echo "<td><button onclick=\"selectCountry1('" . $row1['orszag1'] . "', '" . $row1['repter1'] . "')\">Kiválaszt</button></td>";
        $row1 = $resultUniqueRepterek1->fetch_assoc(); // Következő sor beolvasása
    } else {
    ...
    if ($row2) {
        echo "<td>" . $row2['orszag2'] . "</td>";
        echo "<td>" . $row2['repter2'] . "</td>";
        echo "<td><button onclick=\"selectCountry2('" . $row2['orszag2'] . "', '" . $row2['repter2'] . "')\">Kiválaszt</button></td>";
        $row2 = $resultUniqueRepterek2->fetch_assoc(); // Következő sor beolvasása
    } else {
        echo "<td></td><td></td><td></td>";
    }
